...
/*!***********************!*\
  !*** ./src/index.tsx ***!
  \***********************/
/*! exports provided: parsers, component, getQuery, clearRegistry, parseQueryIntoProps, parseChildrenRemote, zip, mapDelta, loopRootQuery, parseChildren, makeRootQuery, transact, unfoldQueryTerm, unfoldQuery, init */
...
function unfoldQueryTerm(term) {
    ...
    const fullTerms = terms.reduce((terms, term) => [...terms, ...term], []);
