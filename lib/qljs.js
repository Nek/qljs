...
/*!***********************!*\
  !*** ./src/index.tsx ***!
  \***********************/
/*! exports provided: multimethod, parsers, map, query, instance, getQuery, clearRegistry, parseQueryIntoMap, parseChildrenRemote, zip, mapDelta, loopRootQuery, makeRootQuery, parseChildren, transact, componentToQuery, unfoldQueryTerm, unfoldQuery, mount */
...
const map = (atts, Component) => Array.isArray(atts) ? (atts.map(atts => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, atts)))) : (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, atts)));
let Component;
let element;
let state;
let remoteHandler;
...
const instance = (Component, atts) => (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, atts)));
