...
/*!***********************!*\
  !*** ./src/index.tsx ***!
  \***********************/
/*! exports provided: read, mutate, remote, sync, render, component, getQuery, clearRegistry, parseQueryIntoProps, parseChildrenRemote, zip, mapDelta, loopRootQuery, parseChildren, makeRootQuery, transact, componentToQuery, unfoldQueryTerm, unfoldQuery, init */
...
function refresh({ skipRemote } = { skipRemote: true }) {
    if (RootComponent !== undefined) {
        ...
        const props = parseQueryIntoProps(perfRQ(unfoldQuery(getQuery(RootComponent))));
        react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(RootComponent, Object.assign({}, props, { transact: query => transact(props, query) })), element);
    }
}
