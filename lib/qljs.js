...
const alreadyDefined = (id, key) => {
    throw new Error(`${String(id)} parser already has method for "${String(key)}".`);
};
function id(v) {
    return v;
}
const readDict = {};
const read = (id, parser) => {
    readDict[id] = parser;
};
...
const remoteDict = {};
const remote = (id, parser) => {
    remoteDict[id] = parser;
};
const syncDict = {};
const sync = (id, parser) => {
    syncDict[id] = parser;
};
const render = (ctx, Component) => Array.isArray(ctx) ? (ctx.map(ctx => (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, Object.assign(Object.assign({}, ctx), { transact: query => transact(ctx, query) })))))) : (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, Object.assign(Object.assign({}, ctx), { transact: query => transact(ctx, query) }))));
let Component;
let element;
let state;
let remoteHandler;
...
function refresh({ skipRemote } = { skipRemote: true }) {
    if (Component !== undefined) {
        ...
        react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, Object.assign(Object.assign({}, ctx), { transact: query => transact(ctx, query) }))), element);
    }
}
