...
/*!***********************!*\
  !*** ./src/index.tsx ***!
  \***********************/
/*! exports provided: multimethod, read, mutate, remote, sync, render, component, getQuery, clearRegistry, parseQueryIntoProps, parseChildrenRemote, zip, mapDelta, loopRootQuery, makeRootQuery, parseChildren, transact, componentToQuery, unfoldQueryTerm, unfoldQuery, mount */
...
function refresh({ skipRemote } = { skipRemote: true }) {
    if (Component !== undefined) {
        ...
        react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, props, { transact: query => transact(props, query) })), element);
    }
}
