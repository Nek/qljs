...
function refresh({ skipRemote } = { skipRemote: true }) {
    if (Component !== undefined) {
        ...
        react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(createInstance(Component, pipe(getQuery, unfoldQuery, skipRemote ? v => v : perfRQ, parseQueryIntoMap)(Component)), element);
    }
}
