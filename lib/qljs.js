...
const map = (ctx, Component) => Array.isArray(ctx) ? (ctx.map(ctx => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, ctx)))) : (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, ctx)));
let Component;
let element;
let state;
let remoteHandler;
