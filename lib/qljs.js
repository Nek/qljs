...
/*!***********************!*\
  !*** ./src/index.tsx ***!
  \***********************/
/*! exports provided: multimethod, parsers, render, component, instance, getQuery, clearRegistry, parseQueryIntoMap, parseChildrenRemote, zip, mapDelta, loopRootQuery, makeRootQuery, parseChildren, transact, componentToQuery, unfoldQueryTerm, unfoldQuery, mount */
...
const render = (ctx, Component) => Array.isArray(ctx) ? (ctx.map(ctx => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, ctx)))) : (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, ctx)));
let Component;
let element;
let state;
let remoteHandler;
...
const instance = (Component, ctx) => (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, Object.assign({}, ctx)));
...
function refresh({ skipRemote } = { skipRemote: true }) {
    if (Component !== undefined) {
        ...
        react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(instance(Component, atts), element);
    }
}
